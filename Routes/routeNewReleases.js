...
let ModelNewReleases = require('../Models/modelNewReleases')
 
//get request handle
router.get('/',async(req,res)=>{
    try{
        let data = await ModelNewReleases.find();
...
router.post('/',async(req,res)=>{
    try{
        let data = ModelNewReleases(req.body);
        await data.save()
...
router.put('/:id',async(req,res)=>{
    try{
        let data = await ModelNewReleases.findByIdAndUpdate(req.params.id,req.body);
        await data.save()
